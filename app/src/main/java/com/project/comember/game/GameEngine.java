...
public class GameEngine {
    ...
    private CountDownTimer getTimer() {
        ...
        return new CountDownTimer(millisTimerDuration, 30) {
            ...
            public void onTick(long millisUntilFinished) {
                mGameController.setGameTimer((int) ((millisUntilFinished * 100) / millisTimerDuration));
            }
    ...
    private void startNextRound() {
        ...
        new FutureCallback(pauseAfterRound()) {
            @Override
    ...
    private void startTimer() {
        timer.start();
        mGameController.setGameTimer(100);
    }
    ...
    private Future<?> pauseAfterRound() {
        int duration = 1000;
